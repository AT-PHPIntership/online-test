...
<div class="row">
  <div class="col-md-12">
    <div class="box box-primary">
      ...
      <form role="form" action="{{route('admin.parts.update',$part->id)}}" method="POST">
      {{csrf_field()}}
        {{ method_field('PUT') }}
        <div class="box-body">
          ...
          <div class="form-group col-md-6 @if($errors->first('number_answer')) has-error @endif"">
            ...
            <input type="text" class="form-control" name="number_answer" value="{{$part->number_answer}}">
            @if($errors->first('title'))
          ...
          <div class="form-group col-md-6 @if($errors->first('number_question')) has-error @endif">
            ...
            <input type="text" class="form-control"  name="number_question" value="{{$part->number_question}}">
