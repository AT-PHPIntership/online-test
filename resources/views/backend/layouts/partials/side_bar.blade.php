<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class=""><a href="{{ route('admin.admin-user.index') }}"><i class="fa fa-user"></i><span>{!! trans('labels.account') !!}</span></a></li>
      ...
      <li><a href="{{route('admin.news.index')}}"><i class="fa fa-picture-o"></i> <span>{!! trans('labels.new') !!}</span></a></li>
